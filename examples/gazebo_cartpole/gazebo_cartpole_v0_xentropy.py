...
if __name__ == '__main__':
    ...
    obs_size = 4 #Number of input observation variables; in this case its position and angle
    n_actions = 2 #Number of actions that can be taken; in this case its set v to 0.2 or -0.2
    i = 0
    ...
    for iter_no, batch in enumerate(iterate_batches(env, net, BATCH_SIZE)):
        ...
        obs_v, acts_v, reward_b, reward_m = filter_batch(batch, 1/BATCH_SIZE+0.1)
        ...
        loss_v.backward()
        optimizer.step()
        print("Iteration: {} -> Loss: {}".format(i, loss_v.item()))
        i += 1
...
#cd ~/enph353_gym-gazebo-noetic/examples/gazebo_cartpole
#python3 ./gazebo_cartpole_v0_xentropy.py
